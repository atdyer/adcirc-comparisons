...
# run1 = Run('/home/tristan/box/adcirc/runs/refinement/original/', circle)
# run2 = Run('/home/tristan/box/adcirc/runs/refinement/16', circle)
# run3 = Run('/home/tristan/box/adcirc/runs/refinement/4', circle)
