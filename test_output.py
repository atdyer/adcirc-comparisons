...
run1 = Run('/home/tristan/Adcirc/canal/original/')
run2 = Run('/home/tristan/Adcirc/canal/subdomain/')
...
ele_avg_max.save('/home/tristan/Adcirc/canal/average_max_diff.txt')
exit()
